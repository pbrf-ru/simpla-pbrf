...
<!--для отправления запроса, на получение ссылки для пдф-->
<script src="design/js/api_pbrf/pbrf.js"></script>
...
<div id="main">
	...
	&copy; 2011 <a href='http://memories.ks.ua/webmaster'>Simpla {$config->version}</a>
		<a href='index.php?module=LoginAdmin&action=logout' >Выход</a>
	</div>
